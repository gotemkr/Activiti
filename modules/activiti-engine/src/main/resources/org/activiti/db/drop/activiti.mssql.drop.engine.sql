...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_EXCEPTION') alter table ACT_RU_EXCEPTION drop constraint ACT_FK_EXCEPTION_EXEC;
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_EXCEPTION') alter table ACT_RU_EXCEPTION drop constraint ACT_FK_EXCEPTION_PROCINST;
...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_EXCEPTION') drop table ACT_RU_EXCEPTION;
